...
public final class Constants {
    ...
    public static final String EXTRA_ADD_PLACE_LAT = "app.questo.extra.add.place.lat";
    public static final String EXTRA_ADD_PLACE_LON = "app.questo.extra.add.place.lon";
